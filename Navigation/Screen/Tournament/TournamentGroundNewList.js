...
const TournamentGroundNewList = () => {
  ...
  React.useEffect(() => {
    ...
    console.log("Navigation/Screen/Tournament/TournamentGroundNewList.js");
        ...
        <View style={styles.item}>
          ...
          >
            ...
            <Checkbox
              ...
              onValueChange={() => handleCheck(item.id, item.GroundName)}
  ...
  function handleCheck(id, GroundName) {
  ...
  return (
    <View style={styles.Container}>
      ...
      />
      <View style={[styles.width100, { marginBottom: 10 }]}>
        {data.length != 0 ? (
          <FlatList
            data={data}
...
export default TournamentGroundNewList;
