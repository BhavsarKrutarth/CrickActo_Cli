...
const Tournament_SchedualeMatch = (props) => {
  ...
  React.useEffect(() => {
    console.log(
      "Navigation/Screen/Tournament/TournamentMain_Navigation/Tournament_SchedualeMatch.js"
    );
                ...
                },
                {
                  ...
                  onPress: () =>
                    navigation.navigate("Tournament_AddGroups", {
                      RedirectPage: "Tournament_SchedualeMatch",
                    }),
                },
              ]
            );
      ...
      <View style={[styles.body100]}>
        ...
        >
          {ListItems.map((item, index) => (
            <Pressable
              onPress={() => SelectRound(item.id, item.RoundName)}
              key={index}
              style={[styles.body33]}
            >
              <View
...
export default Tournament_SchedualeMatch;
