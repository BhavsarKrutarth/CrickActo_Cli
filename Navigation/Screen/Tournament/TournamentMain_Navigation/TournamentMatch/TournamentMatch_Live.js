...
const TournamentMatch_Live = props => {
  ...
  React.useEffect(() => {
    console.log("Navigation/Screen/Tournament/TournamentMain_Navigation/TournamentMatch/TournamentMatch_Live.js");
...
export default TournamentMatch_Live;