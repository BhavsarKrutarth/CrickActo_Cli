import {
    ...
    /* -----------------------refreshing ------------------------------*/
    const Tournament_MatchSelectStriker = (props) => {
      ...
      React.useEffect(() => {
      console.log("Navigation/Screen/Tournament/Tournament_Match/Tournament_MatchManual/Tournament_MatchSelectStriker.js");
      ...
      Stiker_GET(route.params?.Tournament_Matchid,route.params?.Non_Stickerid)
      ...
      if(route.params?.Matchid)
      {
       ...
       const onRefresh = React.useCallback(() => {
          ...
          {
              Stiker_GET(Tournament_Matchid);
          }
          
         wait(2000).then(() => setRefreshing(false));
       }, [Tournament_Matchid]);
     /* -----------------------refreshing ------------------------------*/
      const Stiker_GET = async (Tournament_Matchid,Non_Stickerid) => {
        try {
          var data ={ 
    ...
    export default Tournament_MatchSelectStriker;
