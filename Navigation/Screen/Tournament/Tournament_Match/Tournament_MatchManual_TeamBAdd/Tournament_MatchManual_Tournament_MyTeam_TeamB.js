...
/* -----------------------refreshing ------------------------------*/
const Tournament_MatchManual_Tournament_MyTeam_TeamB = (props) => {
  ...
  React.useEffect(() => {
    console.log("Navigation/Screen/Tournament/Tournament_Match/Tournament_MatchManual_TeamBAdd/Tournament_MatchManual_Tournament_MyTeam_TeamB.js");
      /* Note :  My team Display  this page  */


    MyTeam(route.params?.TeamAid);
...
export default Tournament_MatchManual_Tournament_MyTeam_TeamB;
