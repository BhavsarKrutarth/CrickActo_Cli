...
const Tournament_Match_TeamBCaptain_WicketKeeper = (props) => {
  ...
  React.useEffect(() => {
    ...
    console.log("Navigation/Screen/Tournament/Tournament_Match/Tournament_Match_TeamB/Tournament_Match_TeamBCaptain_WicketKeeper.js");
        ...
        const resposneJSON = await fetch(
          `${global.domainName}/cricbuddyAPI/api/CommonSp`,
          {
            ...
            headers: {
              ...
              "Content-Type": "application/json",
              Authorization: "FF7B5E5C-A468-4CE0-B812-98008627C8KT",
              SpName:"TOURNAMENT_TEAMBCAPTAIN_WICKETKEEPER_API_CRUD"
            },
            body: JSON.stringify({
              OPER: "Edit",
              TOURNAMENT_MATCHID:Tournament_Matchid,
              ...
              MOBILENO:global.MobileNo,
              TEAMBCAPTAINID:selectedItem_Captain,
              LASTPAGENAME:RedirectPage,
              TEAMBKEEPERTAINID:selectedItem_Keeper == null ? "": selectedItem_Keeper,
              SpName:"TOURNAMENT_TEAMBCAPTAIN_WICKETKEEPER_API_CRUD",
              REDIRECTPAGE:""
            }),
          }
...
export default Tournament_Match_TeamBCaptain_WicketKeeper;