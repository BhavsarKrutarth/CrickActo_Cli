...
const Tournament_Edit_Delete = (props) => {
  /*-------------------- Image Upload  -------------------------------*/
  ...
  React.useEffect(() => {
    ...
    console.log("Navigation/Screen/Tournament/TournamentRightSide_Navigation/Tournament_Edit_Delete.js");
    Tournament_GET();
    storeData();
        ...
        .then((json) => {
          ...
          if (BindData.SERVICERESPONSE.RESPONSECODE == "0") {
            ...
            if (List) {
              ...
              console.log(List.BANNERIMAGE)
              if (List.BANNERIMAGE != 'banner.jpg') {
                setMainBannerUI(true);
                setMainBanner(false);
                if (List.BANNERIMAGE) {
                  setImage(
                    `${global.domainName}/cricbuddyAPI/UploadFiles/UserProfile/${List.BANNERIMAGE}`
                  );
                }
        ...
        >
          ...
          <View style={styles.Container}>
            ...
            <View style={styles.body}>
              ...
              <View style={[styles.width100, { marginTop: 20 }]}>
                ...
                <TextInput
                  ...
                  onFocus={() => navigation.navigate("UserProfileCity", {
                    PageRedirect: "Tournament_Edit_Delete",
                  })}
                  style={{
                    borderBottomColor:
              ...
              <View style={[styles.width100, { marginTop: 20,flexDirection:"row" }]}>
                <View style={{width:"50%"}}>
                  <Pressable
...
export default Tournament_Edit_Delete