import {
  ...
  import { color } from "react-native-reanimated";
    ...
    /* -----------------------refreshing ------------------------------*/
    const NextInning_MatchSelectStriker = (props) => {
      ...
      React.useEffect(() => {
      console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchSelectStriker.js");
          ...
          try {
            const resposneJSON = await fetch(
              ...
              .then((json) => {
                /*-------------------- Page Call -----------------------*/
                var BindData = JSON.parse(json);
                console.log(BindData.SERVICERESPONSE)
    ...
    export default NextInning_MatchSelectStriker;
