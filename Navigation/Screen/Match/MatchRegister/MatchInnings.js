...
const MatchInnings = () => {
  ...
  React.useEffect(() => {
    console.log("Navigation/Screen/Match/MatchRegister/MatchInnings.js");
          ...
          <View style={[styles.width100, styles.WonMainDiv]}>
            <View style={[styles.width50, styles.alignItemsCenter]}>
              ...
              >
                <Pressable
                  onPress={() => {
                    navigation.navigate('MatchSelectStriker',
                    {
                      Matchid:Matchid
            ...
            <View style={[styles.width50, { alignItems: "center" }]}>
              ...
              >
                <Pressable
                   onPress={() => {
                    navigation.navigate('MatchSelectNon_Striker',
                    {
                      Matchid:Matchid
          ...
          <View style={[styles.width100, styles.WonMainDiv]}>
            <View style={[styles.width50, styles.alignItemsCenter]}>
              ...
              >
                <Pressable
                   onPress={() => {
                    navigation.navigate('MatchSelectBowler',
                    {
