import {
  ...
  import { color } from "react-native-reanimated";
    ...
    /* -----------------------refreshing ------------------------------*/
    const NextInning_MatchNextOver = (props) => {
      ...
      React.useEffect(() => {
      console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchNextOver.js");
      ...
      const Bowler_GET = async (Matchid,Where_nq_Bowlerid) => {
        try {
            var data = {
                ...
                SPNAME:"NEXTINNING_MATCH_TEAMA_PLAYER_API_GET",
            ...
            const resposneJSON = await fetch(
              `${global.domainName}/cricbuddyAPI/api/CommonSp`,
              {
                ...
                headers: {
                  ...
                  "Content-Type": "application/json",
                  Authorization: "FF7B5E5C-A468-4CE0-B812-98008627C8KT",
                  SpName:"NEXTINNING_MATCH_BOWLINGSTYLE_API_CRUD"
                },
                body: JSON.stringify({
                  OPER: 'Edit',
                  SPANME:"NEXTINNING_MATCH_BOWLINGSTYLE_API_CRUD",
    ...
    export default NextInning_MatchNextOver;
