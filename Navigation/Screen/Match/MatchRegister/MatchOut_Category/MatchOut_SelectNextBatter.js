import {
  ...
  /* -----------------------refreshing ------------------------------*/
  const MatchOut_SelectNextBatter = (props) => {
    ...
    React.useEffect(() => {
    console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOut_SelectNextBatter.js");
  ...
  export default MatchOut_SelectNextBatter;
