...
const MatchOutBehind_Caught = () => {
    ...
    React.useEffect(() => {
        ...
        console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOutBehind_Caught.js");
    ...
    const FielderUpload = async () => {
        navigation.navigate("MatchOut_FielderList", {
          ...
          TeamBBowlerid:TeamBBowlerid,
          TeamBBowlerName:TeamBBowlerName,
          ReturnPage:"MatchOutBehind_Caught"
        });
    }
    const BtnNext = async () =>
    {
          ...
          const resposneJSON = await fetch(
            `${global.domainName}/cricbuddyAPI/api/MatchTeamA`,
            {
              ...
              body: JSON.stringify({
                ...
                OutByBowlerid: MatchTeamBPlayerid,
...
export default MatchOutBehind_Caught;