...
const MatchOut_Retired_Hurt = () => {
    ...
    React.useEffect(() => {
        console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOut_Retired_Hurt.js");
...
export default MatchOut_Retired_Hurt;