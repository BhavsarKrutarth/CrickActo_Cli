...
const MatchOut_Hit_TheBallTwisce = () => {
    ...
    React.useEffect(() => {
        ...
        console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOut_Hit_TheBallTwisce.js");
...
export default MatchOut_Hit_TheBallTwisce;