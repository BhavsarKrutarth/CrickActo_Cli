...
const MatchOut_Retired = () => {
    ...
    React.useEffect(() => {
        console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOut_Retired.js");
    ...
    return (
        <View style={[styles.container]}>
            ...
            <><View style={[styles.with100, { paddingTop: 10, paddingHorizontal: 10 }]}>
                    <View>
                        <Text style={styles.Title}>Can Batter bat again ?</Text>
                    </View>
...
export default MatchOut_Retired;