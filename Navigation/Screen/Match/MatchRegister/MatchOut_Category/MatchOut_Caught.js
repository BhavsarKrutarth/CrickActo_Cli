...
const MatchOut_Caught = () => {
  ...
  React.useEffect(() => {
    ...
    console.log("Navigation/Screen/Match/MatchRegister/MatchOut_Category/MatchOut_Caught.js");
...
export default MatchOut_Caught;