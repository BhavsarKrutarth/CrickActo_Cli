...
const NextInning_MatchOut = () => {
  ...
  React.useEffect(() => {
    console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchOut.js");
  ...
  const Retired = () => {
    navigation.navigate("NextInning_MatchOut_Retired",
      {
  ...
  const Obstr_The_Field = () => {
    navigation.navigate("NextInning_MatchOut_ObstructingTheField",
      {
        original_Stickerid: original_Stickerid,
        original_StickerName: original_StickerName,
        original_StickerPlayerid: original_StickerPlayerid,
  ...
  const RunOut = async () => {
    navigation.navigate("NextInning_MatchOut_RunOut",
      {
        original_Stickerid: original_Stickerid,
        original_StickerName: original_StickerName,
        original_StickerPlayerid: original_StickerPlayerid,
  ...
  const Stumped = async () => {
    navigation.navigate("NextInning_MatchOutBehind_Caught", {
  ...
  const Hit_TheBallTwisce = () => {
    navigation.navigate("NextInning_MatchOut_Hit_TheBallTwisce", {
      //StickerName:StickerName,
      //Matchid:Matchid,
      TeamABowlerid: TeamABowlerid,
      TeamABowlerName: TeamABowlerName,
  ...
  const Absent_Hurt = () => {
    ...
    navigation.navigate("NextInning_MatchOut_Absent_Hurt", {
      //StickerName:StickerName,
      //Matchid:Matchid,
      TeamABowlerid: TeamABowlerid,
      TeamABowlerName: TeamABowlerName,
  ...
  const Retired_Out = () => {
    navigation.navigate("NextInning_MatchOut_Retired_Out",
      {
        original_Stickerid: original_Stickerid,
        original_StickerName: original_StickerName,
        original_StickerPlayerid: original_StickerPlayerid,
  ...
  const Retired_Hurt = () => {
    navigation.navigate("NextInning_MatchOut_Retired_Hurt",
      {
        original_Stickerid: original_Stickerid,
        original_StickerName: original_StickerName,
        original_StickerPlayerid: original_StickerPlayerid,
  ...
  const Hit_Wicket = () => {
    navigation.navigate("NextInning_MatchOut_Hit_Wicket", {
      //StickerName:StickerName,
      //Matchid:Matchid,
      PageName: "Hit Wicket",
      TeamABowlerid: TeamABowlerid,
  ...
  const Caught_Modal = async () => {
    ...
    navigation.navigate("NextInning_MatchOut_Caught", {
      //StickerName:StickerName,
      //Matchid:Matchid,
      TeamABowlerid: TeamABowlerid,
      TeamABowlerName: TeamABowlerName,
...
export default NextInning_MatchOut
