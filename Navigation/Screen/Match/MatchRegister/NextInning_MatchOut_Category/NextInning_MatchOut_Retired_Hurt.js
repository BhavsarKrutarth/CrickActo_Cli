...
const NextInning_MatchOut_Retired_Hurt = () => {
    ...
    React.useEffect(() => {
        console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchOut_Category/NextInning_MatchOut_Retired_Hurt.js");
    ...
    const btnDone = async () => {
        ...
        var data = {
            ...
            FOURS: 0,
            SIXS: 0,
           // TYPE:isChecked != false ? "RetiredHurt" : "Main", // isChecked != true ? "Main" : "RetiredHurt",
            RETIREDHURT:1,
            NOBALLCHECKED: "",
            OUTBATTERID: "",
            OUTBATTERTYPE: "RetiredHurt",
              ...
              if (BindData.SERVICERESPONSE.RESPONSECODE == 0) {
                if(Matchid)
                {
                 ...
                 else
                 {
                    ...
                    // console.log(DeliveryTypeSelect)
                    // console.log(BindData.SERVICERESPONSE.BOWLECOUNT)
                    // console.log(Bowle)
                    // console.log(BowleCount)
                    // console.log(BindData.SERVICERESPONSE.BOWLECOUNT == 0 && ( BowleCount != 5 || DeliveryTypeSelect == 'WideBall' || DeliveryTypeSelect == 'NoBall' ) ? Bowle :BindData.SERVICERESPONSE.BOWLE)
                    // return
...
export default NextInning_MatchOut_Retired_Hurt;