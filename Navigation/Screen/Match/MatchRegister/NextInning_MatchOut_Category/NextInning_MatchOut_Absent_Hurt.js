...
const NextInning_MatchOut_Absent_Hurt = () => {
    ...
    React.useEffect(() => {
        ...
        console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchOut_Category/NextInning_MatchOut_Absent_Hurt.js");
...
export default NextInning_MatchOut_Absent_Hurt;