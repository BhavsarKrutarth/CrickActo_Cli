...
const NextInning_MatchOut_ObstructingTheField = () => {
    ...
    React.useEffect(() => {
        console.log("Navigation/Screen/Match/MatchRegister/NextInning_MatchOut_Category/NextInning_MatchOut_ObstructingTheField.js");
            ...
            .then((json) => {
              ...
              if (BindData.SERVICERESPONSE.RESPONSECODE == 0) {
                if(Matchid)
                {
                 ...
                 {
                    // console.log(BindData.SERVICERESPONSE.BOWLECOUNT)
                    // console.log(Bowle)
                    // console.log(BindData.SERVICERESPONSE.BOWLE)
                    // console.log(BindData.SERVICERESPONSE.BOWLECOUNT == 0 && DeliveryTypeSelect != 'ByeBall' && DeliveryTypeSelect != 'LegByeBall' ? Bowle :BindData.SERVICERESPONSE.BOWLE)
                    // return
                    navigation.navigate("NextInning_MatchNextBatterTeamB",{
                     ...
                     Ball:BindData.SERVICERESPONSE.BOWLECOUNT == 0 && DeliveryTypeSelect != 'ByeBall' && DeliveryTypeSelect != 'LegByeBall' ? Bowle :BindData.SERVICERESPONSE.BOWLE,
                     BowleCount:BindData.SERVICERESPONSE.BOWLECOUNT == 0 && DeliveryTypeSelect != 'ByeBall' && DeliveryTypeSelect != 'LegByeBall' ? BowleCount :BindData.SERVICERESPONSE.BOWLECOUNT,
                     BowleOver:BindData.SERVICERESPONSE.BOWLEOVER,
                     BowlerWiseBallCount:BindData.SERVICERESPONSE.BOWLECOUNT == 0 && DeliveryTypeSelect != 'ByeBall' && DeliveryTypeSelect != 'LegByeBall' ? BowlerWiseBallCount :BindData.SERVICERESPONSE.BOWLERWISEBALLCOUNT,
    ...
    return (
        <View style={[styles.container]}>
            ...
            <Pressable onPress={() => btnDone()} style={[styles.with100,styles.btnout]}>
                <Text onChangeText={setRunScoredSelect} value={RunScoredSelect} style={{color:"white"}}>OBSTRUCTING</Text>
            </Pressable>
            </ScrollView>
        </View>
    )
...
export default NextInning_MatchOut_ObstructingTheField;