...
const TeamASelectPlayer = (props) => {
  ...
  React.useEffect(() => {
    console.log("Navigation/Screen/Match/TeamAdd/TeamA/TeamASelectPlayer.js");
    ...
    if (route.params?.TeamAid) {
      ...
      Player_GET(route.params?.TeamAid)
      setbtnDisplay(true)
  ...
  const Player_GET = async (MyTeamId) => {
    ...
    try {
      const resposneJSON = await fetch(
        `${global.domainName}/cricbuddyAPI/api/TeamASelectPlayerEdit`,
        {
          method: "GET",
          headers: {
          ...
          const resposneJSON = await fetch(
            `${global.domainName}/cricbuddyAPI/api/TeamASelectPlayer`,
            {
              ...
              body: JSON.stringify({
                Oper: "add",
                Matchid: Matchid,
                LastPageName: "TeamACaptain_WicketKeeper",
          ...
          <Pressable
            onPress={() =>
              navigation.navigate("PlayerAddViaPhoneNo", {
                PLayer_RedirectPage: "TeamASelectPlayer",
                MyTeam: MyTeam,
                MyTeamId: MyTeamId,
              })
            }
...
export default TeamASelectPlayer;
